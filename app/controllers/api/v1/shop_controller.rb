...
class Api::V1::ShopController < ApplicationController
  ...
  def index
      ...
      uri = URI("https://openapi.etsy.com/v2/shops/SmartAndBright/listings/active?api_key=sb3eo6ddzfr63l3s6432y5l2")  # making the URI call
      ...
      result['results'].each do |lot|
          ...
          uri_photo = URI("https://openapi.etsy.com/v2//listings/#{lot['listing_id']}/images?api_key=sb3eo6ddzfr63l3s6432y5l2")  # making the URI call to get the photograph
